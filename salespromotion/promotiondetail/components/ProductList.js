...
class ItemList extends React.Component {
    ...
    render() {
        let { state: { iteType, pageSize, pageNo, totalCount, modalVisible, language, productList, expandedRowKeys } = {}, handlers } = this.props
        ...
        return (
            ...
            <section className="item-list">
                <Table dataSource={productList}
                    ...
                    onExpandedRowsChange={handlers.handleChangeExpandedRows}
                ...
                >
                    ...
                    <Column
                        ...
                        render={(text, record) => <div>
                            <div>{language["promotion.search.inprogress"]}：{record.doingSize}</div>
                            <div>{language["promotion.search.Notyetbegun"]}：{record.unStartSize}</div>
                        </div>
                        }
                    />
                    <Column
